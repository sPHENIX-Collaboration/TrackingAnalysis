...
void plot()
{
  ...
  TPaveText *pt7 = new TPaveText(.70, .85, 1.0, 1., "NDC");
  ...
  TPaveText *pt8 = new TPaveText(.70, .85, 1.0, 1., "NDC");
  ...
  h2_eop_p_ep->SetTitle("#it{#bf{sPHENIX}} Internal, p+p #sqrt{s}=200 GeV, Run 53741-53744, 28.46 Million");
  TPaveText *pt9 = new TPaveText(.70, .85, 1.0, 1., "NDC");
  ...
  h2_eop_p_em->SetTitle("#it{#bf{sPHENIX}} Internal, p+p #sqrt{s}=200 GeV, Run 53741-53744, 28.46 Million");
  TPaveText *pt10 = new TPaveText(.70, .85, 1.0, 1., "NDC");
...
void drawsPHENIXInternal(TPaveText *pt)
{
  ...
  pt->AddText(Form("Run 53741-53744, 28.46 Million"));
}
