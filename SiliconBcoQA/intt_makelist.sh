...
for i in {0..7}
do
/bin/ls -1 /sphenix/lustre01/sphnxpro/physics/INTT/${type}/${type}_intt${i}-${runnumber}-* > intt${i}_${runnumber}.list
if [ ! -s intt${i}_${runnumber}.list ]
then
  echo intt${i}_${runnumber}.list empty, removing it
  rm intt${i}_${runnumber}.list
fi
