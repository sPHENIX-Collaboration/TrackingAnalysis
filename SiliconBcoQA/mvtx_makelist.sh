...
for i in {0..5}
do
ls -1 /sphenix/lustre01/sphnxpro/physics/MVTX/${type}/${type}_mvtx${i}-${runnumber}-* > mvtx${i}_${runnumber}.list
if [ ! -s mvtx${i}_${runnumber}.list ]
then
  echo mvtx${i}_${runnumber}.list empty, removing it
  rm mvtx${i}_${runnumber}.list
fi
